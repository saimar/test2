...
public class FasesVO implements Serializable{
	 ...
	 private static final long serialVersionUID = 1L;
		...
		public FasesVO(BigDecimal idFace, String nombre, String descripcion, BigDecimal idEtapa, int estatus,
		...
		public FasesVO(BigDecimal idFace, String nombre, String descripcion, int estatus, BigDecimal idEtapa, String desEstatus) {
			super();
			this.idFace = idFace;
			this.nombre = nombre;
			this.descripcion = descripcion;
