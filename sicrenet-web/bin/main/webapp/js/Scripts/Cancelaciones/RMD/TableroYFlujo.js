...
function funcionLoadMasterPage() {
    ...
    peticionAjax("TableroYFlujo.aspx/GetAñoMesActual", "POST", null, function (dataF) {
        mesAñoActual = dataF.d;
        peticionAjax("TableroYFlujo.aspx/GetValorArgumentos", "POST", { opcion: 1 }, function (data) {
            if (data.d == "") {
...
function CargaAñoMes() {
    Waiting(true, "Espere por favor. Cargando Información...");
    peticionAjax("TableroYFlujo.aspx/GetValorArgumentos", "POST", { opcion: 2 }, function (data) {
