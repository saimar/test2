...
(function (global, undefined) {
	...
	Alertify = function () {
		...
		var _alertify = {},
		    ...
		    queue     = [],
		    $, btnCancel, btnOK,btnOK1, btnReset, btnFocus, elCallee, elCover, elDialog, elLog, form, input, getTransitionEvent;
		...
		dialogs = {
			buttons : {
				...
				ok1: "<a href=\"#\" class=\"alertify-button alertify-button-ok\" id=\"alertify-ok1\">{{Aceptar}}</a>",
		...
		_alertify = {
			...
			addListeners : function (fn) {
			    var hasOK = (typeof btnOK !== "undefined"),
                    hasOK1 = (typeof btnOK1 !== "undefined"),
				    hasCancel = (typeof btnCancel !== "undefined"),
				    hasInput  = (typeof input !== "undefined"),
				    val       = "",
				    self      = this,
				    ok, ok1, cancel, common, key, reset;
				...
				common = function (event) {
					...
					if (hasOK1) self.unbind(btnOK1, "click", ok);
				...
				if (hasOK1) this.bind(btnOK1, "click", ok);
				// handle Cancel click
			...
			build : function (item) {
				...
				case "alert":
					...
					break;
				case "Comentario":
				    html = html.replace("{{buttons}}",dialogs.buttons.ok1);
				    //html = html.replace("{{ok}}", this.labels.ok).replace("{{cancel}}", this.labels.cancel);
				    html = html.replace("{{Aceptar}}", this.labels.ok1);

				    //html =  "<div class='mainTab'>Esto solo es una prueba</div>";
		...
		return {
			...
			Comentario: function (message, fn, cssClass) { _alertify.dialog(message, "Comentario", fn, "", cssClass); return this; },
