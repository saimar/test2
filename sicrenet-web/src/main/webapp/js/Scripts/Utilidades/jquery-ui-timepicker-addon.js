            ...
            init: function (options) {
                ...
                var mdp_events = {
                    ...
                    onSelect: function (dateText, inst) {
                        if( this.multiDatesPicker.aplicarCondicion) { Waiting(true, "Espere por favor. Cargando Información...");
                        ...
                        if (dateText && this.multiDatesPicker.aplicarCondicion) {
                            $this.multiDatesPicker('toggleDate', dateText);
                        }

                        if (this.multiDatesPicker.mode == 'normal' && this.multiDatesPicker.dates.picked.length > 0 && this.multiDatesPicker.pickableRange && this.multiDatesPicker.aplicarCondicion) {
                        ...
                        } else if (this.multiDatesPicker.aplicarCondicion) {
                            $this
								.datepicker("option", "minDate", this.multiDatesPicker.minDate)
								.datepicker("option", "maxDate", this.multiDatesPicker.maxDate);
                        }

                        if ((this.tagName == 'INPUT' || this.tagName == 'DIV')&& this.multiDatesPicker.aplicarCondicion) { // for inputs
                            $this.val(
                    ...
                    beforeShowDay: function (date) {
                        ...
                        var highlight_class = gotThisDate ? 'coloRed' : custom[1];
                    ...
                    onClose: function (dateText, inst) {
                        if (this.tagName == 'INPUT' && this.multiDatesPicker.changed && this.multiDatesPicker.aplicarCondicion) {
                            $(inst.dpDiv[0]).stop(false, true);
                            setTimeout('$("#' + inst.id + '").datepicker("show")', 50);
                        }
                        else  if (this.tagName == 'INPUT' && this.multiDatesPicker.changed && !this.multiDatesPicker.aplicarCondicion) {
                            fechaP = $("#dpFechaPeriodoGral").attr("value").split('/')[2] + ',' + $("#dpFechaPeriodoGral").attr("value").split('/')[1] + ',' + $("#dpFechaPeriodoGral").attr("value").split('/')[0];
                            DeteminaFechaValidaBtnMiniAgenda();
