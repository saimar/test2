...
//    $("#saludo").css("visibility", "collapse");

//    $(".spacerA").css("display", "none");
//    $(".spacerB").css("display", "none");

//    $("#divFavoritos").animate({ width: "0px" });
//    $("#tblFavoritos").hide();
//    $("#imgOcultarFavoritos").hide();

//    $("#Incidencias").css("visibility", "visible");
//    $("#Incidencias").css("display", "block");
//    $("#Incidencias").css("height", parseInt($(window).height()) - 145 + "px");
//    $("#divTablaRgulatorio").css("height", parseInt(screen.height) - 160 + "px");

//}

window.addEventListener("resize", myfuncTamanio);
function myfuncTamanio() {
    console.log((parseInt($(window).width() - 40) + 'px'));

    $("#Incidencias").css("height", (parseInt($(window).height())) - 145 + "px");
    $("#divTablaRgulatorio").css({ "max-width": (parseInt($(window).width() - 40) + 'px') });
    $("#divTablaRgulatorio").css("height", (parseInt($(window).height())) - 160 + "px");
...
function vtnEspera_size(popUpDivVar) {
    if (typeof window.innerWidth != 'undefined') {
        viewportheight = window.innerHeight;
    } else {
        viewportheight = document.documentElement.clientHeight;
    ...
    var blanket = document.getElementById('vtnEspera');
    //blanket.style.height = '200px';
    blanket.style.height = blanket_height + 'px';

    var popUpDiv = document.getElementById(popUpDivVar);

    popUpDiv_height = blanket_height / 2 - 900;//200 is half popup's height
    //popUpDiv.style.top = popUpDiv_height + 'px';
    popUpDiv.style.top = ($(window).height() - $('#vtnImagen').outerHeight()) / 2 + 'px';
    popUpDiv.style.height = '130px';
}
...
function vtnEspera_window_pos(popUpDivVar) {
    if (typeof window.innerWidth != 'undefined') {
        viewportwidth = window.innerHeight;
    } else {
        viewportwidth = document.documentElement.clientHeight;
    ...
    window_width = window_width / 2 - 200;//200 is half popup's width
    //popUpDiv.style.left = window_width + 'px';
    popUpDiv.style.left = ($(window).width() - $('#vtnImagen').outerWidth()) / 2 + 'px';
}
...
function ventanaEspera() {
    vtnEspera_size('vtnImagen');
    vtnEspera_window_pos('vtnImagen');
    toggle('vtnEspera');
    toggle('vtnImagen');
    $('#vtnImagen').css('width', '250px');
}
...
function PosicionaVentanaEnCentro(identificador) {
    if (identificador == ".divVtnsFlotantes") {
        $(identificador).parent().parent().position({
            my: "center",
            at: "center",
            of: window
        });
...
function cargarActividades() {
    ...
    //muestraPendientes();
    peticionAjax('pendientesIframe.aspx/obtieneDatosGenerales', "POST", {},
    function (data) {
        if (data.d != null && data.d.split('-')[0] != "Error") {
            ...
            PaisSelecXUser = 1;
            //if (PaisSelecXUser != 0) 
            //    PaisSelecXUser = parseInt(data.d.split('-')[2]);

            peticionAjax('pendientesIframe.aspx/obtieneTotalesPendientes', "POST", { nResponsable: idAutenticado },
                function (data) {
                    if (data.d != null && data.d.split('-')[0] != "Error") {
...
function cargarIncidencias() {
    ...
    peticionAjax('pendientesIframe.aspx/GetIncidencias', "POST", { nombre: idAutenticado },
    function (data) {
        if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
            ...
            //$("#divTablaRgulatorio").css("height", screen.height - 430 + "px");
...
function ExportExcel() {
    ...
    peticionAjax('pendientesIframe.aspx/ExportExcel', "POST", { cadena: "" },
    function (data) {
        if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
            var JSONR = obtenerArregloDeJSONModificado(data.d.split('-->')[0], false); // Responsable
...
function construyeDatosTablaInsidencias(JSONR, JSONR1, JSONR2) {
    ...
    if (!bDato) {
        auxCad += '<center><br><br><div>' +
                        ...
                        '<p style="padding:30px; font-size:28px; color: rgba(0, 0, 254, 1);"> Sin Pendientes</p>' +
                  '</div>';
        auxCad += '</td></center>';
    }
    else {
...
function AbrirComentariosIncidencias2(txt, obj, clave, negocio) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/GetIncidenciasComentarios', "POST", { sClave: clave, sNegcio: negocio },
        function (data) {
            if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
                if (data.d != "") {
...
function GuardaComentariosIncidencias(txt, clave, negocio) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/InsertaComentariosIncidencias', "POST", { sClave: clave, sComentario: $("#TextMessage").val(), sNegocio: negocio },
       function (data) {
           if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
               var JSON = obtenerArregloDeJSONModificado(data.d, false);
...
function cargarTabla(nombreC) {
    peticionAjax('pendientesIframe.aspx/GetPendientesRegulatorios', "POST", { Responsable: nombreC, idPais: PaisSelecXUser },
    function (data) {
        if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
            var JSONR = obtenerArregloDeJSONModificado(data.d.split('-->')[0], false);
...
function validaAlmacenaArchivo_Regulatorios() {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/validaAlmacenaArchivo_Regulatorios', "POST", {},
         function (data) {
...
function almacenaArchivo_Regulatorios(param, Datos) {
    peticionAjax('pendientesIframe.aspx/almacenaArchivo_Regulatorios', "POST", param, function (data) {
...
function AbrirComentariosRegulatorios2(txt, idPais, idSegmento, idReporte, idPeriodicidad, idEmpleado, idSeccion, FechaCorte, NoSerie) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/GetPendientesRegulatorioComentarios', "POST", { FIIdPais: idPais, FIIdReporte: idReporte, FIIdSegmentacion: idSegmento, FIIdPeriodicidad: idPeriodicidad, FIIdEmpleado: idEmpleado, FIIdSeccion: idSeccion, FechaCorte: FechaCorte, NoSerie: NoSerie },
        function (data) {
            if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
                if (data.d != "") {
                    var JSON = obtenerArregloDeJSONModificado(data.d, false);
...
function GuardaComentarios(txt) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/InsertPendientesComentarios', "POST", {
...
function cargarOficios() {
    peticionAjax('pendientesIframe.aspx/GetOficios', "POST", { nombre: idAutenticado },
       function (data) {
           if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
               var JSONR = obtenerArregloDeJSONModificado(data.d.split('-->')[0], false); // Responsable
               var JSONR1 = obtenerArregloDeJSONModificado(data.d.split('-->')[1], false);// Corresponsable
...
function validaAlmacenaArchivo_Oficios() {
    Waiting(true, "Cargando Información...");
    peticionAjax('pendientesIframe.aspx/validaAlmacenaArchivo_Oficios', "POST", {},
         function (data) {
             if (data.d.split('#')[0] == "Subir") {
...
function almacenaArchivo_oficios(Datos) {
    ...
    peticionAjax('pendientesIframe.aspx/almacenaArchivo_oficios', "POST", param, function (data) {
        if (data.d.split("-")[0] == 'Error') {
            var cad = 'Error en la subida de Archivo. <br/>';
            MostrarMsj(data.d.indexOf("Error") != -1 ? cad : "Error en el Archivo.", "Mensaje", false, true, false, "", "Aceptar", "", 350, 220, null, function () {
                entroCloseBtnAceptar = true;
...
function AbrirComentariosOficios2(txt, obj, oficio) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/GetComentariosOficio', "POST", { sOficio: oficio, nResponsable: idAutenticado },
        function (data) {
            if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
                if (data.d != "") {
                    var JSON = obtenerArregloDeJSONModificado(data.d, false);
...
function GuardaComentariosOficios(txt, oficio) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/InsertaComentariosOficios', "POST", { sOficio: oficio, sComentario: $("#TextMessage").val(), nResponsable: idAutenticado },
       function (data) {
           if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
               var JSON = obtenerArregloDeJSONModificado(data.d, false);
...
function cargarTablaActividades() {
    peticionAjax('pendientesIframe.aspx/GetActividades', "POST", { idPais: PaisSelecXUser, Responsable: idAutenticado },
    function (data) {
        if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
...
function validaAlmacenaArchivo_Actividades() {
    Waiting(true, "Cargando Información...");
    peticionAjax('pendientesIframe.aspx/validaAlmacenaArchivo_Actividades', "POST", {},
         function (data) {
             if (data.d.split('#')[0] == "Subir") {
...
function almacenaArchivo_Actividades(Datos) {
    ...
    peticionAjax('pendientesIframe.aspx/almacenaArchivo_Actividades', "POST", param, function (data) {
        if (data.d.split("-")[0] == 'Error') {
            var cad = 'Error en la subida de Archivo. <br/>';
            MostrarMsj(data.d.indexOf("Error") != -1 ? cad : "Error en el Archivo.", "Mensaje", false, true, false, "", "Aceptar", "", 350, 220, null, function () {
                entroCloseBtnAceptar = true;
...
function AbrirComentariosActividades2(txt, obj, clave) {
    ...
    peticionAjax('pendientesIframe.aspx/GetPendientesActividadesComentarios', "POST", { iClave: clave },
        function (data) {
            if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
                if (data.d != "") {
                    var JSON = obtenerArregloDeJSONModificado(data.d, false);
...
function GuardaComentariosActividades(txt, clave) {
    ventanaEspera();
    peticionAjax('pendientesIframe.aspx/InsertaComentariosActividades', "POST", { iClave: clave, sComentario: $("#TextMessage").val(), Responsable: parseInt(idAutenticado) },
       function (data) {
           if (data.d != null && data.d.indexOf("ERRORCATCH") == -1) {
               var JSON = obtenerArregloDeJSONModificado(data.d, false);
               $("#" + txt).html(JSON[0]["Fecha"] + ' ' + $("#TextMessage").val());
