...
function BreadcrumbDirective($interpolate, $breadcrumb, $rootScope) {
    var $$templates = {
        bootstrap2: '<ul class="breadcrumb">' +
            ...
            '</ul>',
        bootstrap3: 
        	//'<div id="barraNavegacion" class=" breadcrumb-wrapper hidden-xs"> <span class="label">'+
        	//'Tu estas aqui:</span>'+ 
        	'<ol id="barraNavegacion" class="breadcrumb-wrapper breadcrumb">' +
            '<li ng-repeat="step in steps" ng-class="{active: $last}" ng-switch="$last || !!step.abstract">' +
            '<i ng-show="$first" class="fa fa-home"></i>&nbsp;'+
            '<a ng-switch-when="false" style="color:#999" href="{{step.ncyBreadcrumbLink}}">{{step.ncyBreadcrumbLabel}}</a>' +
            '<span ng-switch-when="true" style="color:#585858;font-weight: bold;">{{step.ncyBreadcrumbLabel}}</span>' +
            '</li>' //+
            //'</ol> </div>'
    };
